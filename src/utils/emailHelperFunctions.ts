      ...
      Messages: [
        {
          ...
          TextPart: `Hi ${name},\n\nYou have requested a link to reset your password, please click in the following link to introduce your new password.\n\n${websiteDomain}/reset-password?token=${token}&name=${name}`,
          HTMLPart: `<h3>Hi ${name}</h3><br />You have requested a link to reset your password, please click in the following link to introduce your new password.<br /> <a href="${websiteDomain}/reset-password?token=${token}&name=${name}">Reset your password here!</a>  <br /><br /> If it was not you, please ignore this mail.`,
